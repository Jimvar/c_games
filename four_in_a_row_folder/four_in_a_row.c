...
int main(){
    ...
    printf("\n");
    printf("%sFFFFFFFFFFFFFFFFFFFFFF                                                          iiii                                                                                                                            \n", RED);
    printf("%sF::::::::::::::::::::F                                                         i::::i                                                                                                                           \n", RED);
    printf("%sF::::::::::::::::::::F                                                          iiii                                                                                                                            \n", RED);
    printf("%sFF::::::FFFFFFFFF::::F                                                                                                                                                                                         \n", RED);
    printf("%s  F:::::F       FFFFFFooooooooooo   uuuuuu    uuuuuu rrrrr   rrrrrrrrr        iiiiiiinnnn  nnnnnnnn           %saaaaaaaaaaaaa        rrrrr   rrrrrrrrr      ooooooooooo wwwwwww           wwwww           wwwwwww\n", RED, CYAN);
    printf("%s  F:::::F           oo:::::::::::oo u::::u    u::::u r::::rrr:::::::::r       i:::::in:::nn::::::::nn         %sa::::::::::::a       r::::rrr:::::::::r   oo:::::::::::oow:::::w         w:::::w         w:::::w \n", RED, CYAN);
    printf("%s  F::::::FFFFFFFFFFo:::::::::::::::ou::::u    u::::u r:::::::::::::::::r       i::::in::::::::::::::nn        %saaaaaaaaa:::::a      r:::::::::::::::::r o:::::::::::::::ow:::::w       w:::::::w       w:::::w  \n", RED, CYAN);
    printf("%s  F:::::::::::::::Fo:::::ooooo:::::ou::::u    u::::u rr::::::rrrrr::::::r      i::::inn:::::::::::::::n       %s         a::::a      rr::::::rrrrr::::::ro:::::ooooo:::::o w:::::w     w:::::::::w     w:::::w   \n", RED, CYAN);
    printf("%s  F:::::::::::::::Fo::::o     o::::ou::::u    u::::u  r:::::r     r:::::r      i::::i  n:::::nnnn:::::n       %s  aaaaaaa:::::a       r:::::r     r:::::ro::::o     o::::o  w:::::w   w:::::w:::::w   w:::::w    \n", RED, CYAN);
    printf("%s  F::::::FFFFFFFFFFo::::o     o::::ou::::u    u::::u  r:::::r     rrrrrrr      i::::i  n::::n    n::::n       %saa::::::::::::a       r:::::r     rrrrrrro::::o     o::::o   w:::::w w:::::w w:::::w w:::::w     \n", RED, CYAN);
    printf("%s  F:::::F          o::::o     o::::ou::::u    u::::u  r:::::r                  i::::i  n::::n    n::::n      %sa::::aaaa::::::a       r:::::r            o::::o     o::::o    w:::::w:::::w   w:::::w:::::w      \n", RED, CYAN);
    printf("%s  F:::::F          o::::o     o::::ou:::::uuuu:::::u  r:::::r                  i::::i  n::::n    n::::n     %sa::::a    a:::::a       r:::::r            o::::o     o::::o     w:::::::::w     w:::::::::w       \n", RED, CYAN);
    printf("%sFF:::::::FF        o:::::ooooo:::::ou:::::::::::::::uur:::::r                 i::::::i n::::n    n::::n     %sa::::a    a:::::a       r:::::r            o:::::ooooo:::::o      w:::::::w       w:::::::w        \n", RED, CYAN);
    printf("%sF::::::::FF        o:::::::::::::::o u:::::::::::::::ur:::::r                 i::::::i n::::n    n::::n     %sa:::::aaaa::::::a       r:::::r            o:::::::::::::::o       w:::::w         w:::::w         \n", RED, CYAN);
    printf("%sF::::::::FF         oo:::::::::::oo   uu::::::::uu:::ur:::::r                 i::::::i n::::n    n::::n      %sa::::::::::aa:::a      r:::::r             oo:::::::::::oo         w:::w           w:::w          \n", RED, CYAN);
    printf("%sFFFFFFFFFFF           ooooooooooo       uuuuuuuu  uuuurrrrrrr                 iiiiiiii nnnnnn    nnnnnn       %saaaaaaaaaa  aaaa      rrrrrrr               ooooooooooo            www             www           \n", RED, CYAN);
    printf("\n");
